      ...
      <View style={styles.content}>
        <CustomContainer extraStyle={styles.contentContainer}>
          <CustomText extraStyle={styles.contentText}>
            {`Marcus the "Arctic Rider" is a traveler who never stays still.\nHe’s always on the road, exploring new routes, chasing new horizons, and living for the feeling of the journey itself.\nEvery road is different, and not every ride is perfect.\nTo keep moving forward, Marcus needs a reliable ride that won’t let him down.\nPlay the game, earn points,upgrade vehicles, and help Marcus travel further — wherever the road decides to take him.`}
          </CustomText>
        </CustomContainer>
